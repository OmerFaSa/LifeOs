...
SP.C = (function(){
  ...
  function Kutu(o){
    ...
    return html`<section class="${cls('kutu', o.class)}" data-oz="002" ${when(o.id, () => attrs({ id:o.id }))}>
      ${when(bas, () => html`<header class="kutu__bas">
        ...
        ${when(o.ad, () => html`<h2 class="kutu__ad">${o.ad}${when(o.ipucu, () => raw(SP.UI.hint(o.ipucu)))}</h2>`)}
  ...
  return {
    Kutu, ModulIsareti, SayfaBolumleri, bolumeGit, Ayrinti, SakinHata, TemaSecici, Katmanli, Card, Collapsible, Stat, Bar, Meter, Badge, Chip, Button, IconButton, Segmented, Subtabs,
    Entry, Ledger,
    PickCard, Toolbar,
