...
ESP.HINTS = {
  ...
  'hkm':{ t:'HKM işareti', b:'İsteğe bağlı dördüncü katmana günün özetini gönderir.',
    more:'ESP, HKM\'nin varlığını bilir ama ona bağımlı değildir: işaret hiçbir çizimde çalışmaz ve hiçbir kaydı bekletmez, HKM kapalıyken ESP olduğu gibi çalışır. Varsayılan kapalıdır ve açılmadan önce ne gönderileceği satır satır gösterilir. Aynı anahtar günde bir kez ESP\'nin bütün verisini HKM\'ye yedekler. Günün özetinde kart metni, not içeriği ve kitap adı gitmez; giden şey dört sayıdır ve her biri kesinlik etiketiyle gider — değeri olmayan alan «veri yok» gider, sıfır değil.' },
