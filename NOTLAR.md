...
| Araç | AYS | SPI | ESP |
|---|---|---|---|
| `runtests.js` | 1237/1237 gecti | 986/986 gecti | 804/804 gecti |
...
| `perfcheck.js` | Bütün ekranlar bütçede — en ağırı office 61.3 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 35.4 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 57.1 ms (bütçe 100). |
