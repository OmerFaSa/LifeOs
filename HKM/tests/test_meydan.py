...
def run():
    ...
    def t_sayfa():
        ...
        # HKM'nin icinde: yuzde Bugun › Meydan bolumu (kullanici karari 2026-09-25).
        ok('href="#/meydan" data-yol="meydan"' in yuz, "yuzde Meydan bolumu yok")
        ok("meydan:'bugun'" in yuz and "'/meydan?gomulu=1'" in yuz, "Meydan Bugun cekmecesine bagli degil")
        for yasak in (">Evet<", ">Tamam<", "Evet,"):
            no(yasak in s, "onay dugmesi etiketsiz: %s" % yasak)
    test("sayfa sifir bagimli, yuzun jetonunu ve temasini okur, yuzde Bugun › Meydan; «Evet/Tamam» yok", t_sayfa)
