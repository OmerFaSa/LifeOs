...
| Araç | AYS | SPI | ESP |
|---|---|---|---|
| `runtests.js` | 1655/1655 gecti | 1294/1294 gecti | 1328/1328 gecti |
...
| `perfcheck.js` | Bütün ekranlar bütçede — en ağırı office 44.9 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 23.3 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 44.6 ms (bütçe 100). |
...
| `ortak.py` | Ortak kaynak: kopyalar kaynakla ayni (42 dosya, 125 kopya). |
