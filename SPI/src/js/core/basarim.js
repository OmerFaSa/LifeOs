...
/* BAŞARIM MOTORU — rozet sayar, kazanımı yakalar, defteri tutar.
   ...
   üç arayüzün `src/js/core/` klasörüne kopyalanır. `SP` ve `spi`
   ...
   okunur (`SP.BasarimSayim`), özete EŞİTLENİR, rozetler eşiklerden
...
SP.Basarim = (function(){
  ...
  async function yaz(){
    ...
    try{ await SP.Store.set(YOL, defter); }catch(e){}
    return defter;
  }
