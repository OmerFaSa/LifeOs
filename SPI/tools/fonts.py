...
Neden gomuyoruz: uygulama «cevrimdisi calisir, bagimliligi yoktur» diyor
ama uc yazi ailesi Google Fonts'tan iniyordu ve bu istek ACILISI
KILITLIYORDU. Olculdu: CDN kapaliyken ilk cizim 342 ms, CDN yanit
vermiyorken 12.931 ms. Otuz sekiz kat fark ve tamami agdan.

Dosyalar Turkce icin gereken karakterlere indirgenmis degisken
yazi tipleridir (bkz. src/fonts/OKU.md). Toplam ~94 KB; base64
sisirmesiyle ~126 KB. Bir defa iner, sonra hicbir sey beklemez.
