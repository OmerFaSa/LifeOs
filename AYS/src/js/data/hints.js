...
R.HINTS = {
  ...
  'hkm':{ t:'HKM işareti', b:'İsteğe bağlı dördüncü katmana günün özetini gönderir.',
    more:'AYS, HKM\'nin varlığını bilir ama ona bağımlı değildir: işaret hiçbir çizimde çalışmaz ve hiçbir kaydı bekletmez, HKM kapalıyken AYS olduğu gibi çalışır. Varsayılan kapalıdır ve açılmadan önce ne gönderileceği satır satır gösterilir. Aynı anahtar günde bir kez AYS\'nin bütün verisini HKM\'ye yedekler. Günün özetinde soru metni, hata defteri ve deneme ayrıntısı gitmez; giden şey birkaç sayıdır ve her biri kesinlik etiketiyle gider — değeri olmayan alan «veri yok» gider, sıfır değil.' },
