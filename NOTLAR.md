...
| Araç | AYS | SPI | ESP |
|---|---|---|---|
| `runtests.js` | 1258/1258 gecti | 1007/1007 gecti | 825/825 gecti |
...
| `perfcheck.js` | Bütün ekranlar bütçede — en ağırı office 59.3 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 34.3 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 60.7 ms (bütçe 100). |
