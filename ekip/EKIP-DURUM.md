...
- ✅ **K · T-DEVIR 8. madde — son rapor (kullanıcıya, 2026-09-25).** Katalog **183/183** yerinde (ekranda ya da testte; 167 T'nin rozeti). Kullanıcıdan beklenen / kod dışı sınırlar:
  1. **Portreler:** 25 kare portrenin **20'si delikli** (`tools/marka.py --delik`, bugün ölçüldü: en kötü montaigne %6,2, analist %4,9, tyt %4,8 … en az ayt %0,2). Temiz kaynak görsel gerekiyor; gelince `python3 tools/marka.py <klasör>` aynı adla değiştirir.
