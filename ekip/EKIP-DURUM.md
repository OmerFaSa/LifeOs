...
- **Bulgu özeti** (`T2-NN → sahip · durum`, ayrıntı `ekip/HATALAR.md` Tur 2): T2-01 → K · açık (fark rozeti «+0» renkli) · T2-02 → K/137 · açık (AYS Ofis'te ham veri kimlikleri) · T2-03 → K · açık (grafik.js zaman damgasından UTC günü)
- **Son tam koşum:** —
