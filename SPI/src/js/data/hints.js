...
SP.HINTS = {
  ...
  'hkm':{ t:'HKM işareti', b:'İsteğe bağlı dördüncü katmana günün özetini gönderir.',
    more:'SPİ, HKM\'nin varlığını bilir ama ona bağımlı değildir: işaret hiçbir çizimde çalışmaz ve hiçbir kaydı bekletmez, HKM kapalıyken SPİ olduğu gibi çalışır. Varsayılan kapalıdır ve açılmadan önce ne gönderileceği satır satır gösterilir. Aynı anahtar günde bir kez SPİ\'nin bütün verisini HKM\'ye yedekler. Günün özetinde tahlil değeri, ilaç adı, semptom ve öğün gitmez; giden şey yük kararını etkileyen dört sayıdır ve her biri kesinlik etiketiyle gider — değeri olmayan alan «veri yok» gider, sıfır değil. Klinik sınır burada da geçerlidir.' },
