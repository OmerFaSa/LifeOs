...
(function(){
  ...
  describe('HKM işareti — sözleşme', () => {
    ...
    it('gövde yalnızca sayı taşır, içerik taşımaz', () => {
      ...
      expect(Object.keys(p.metrics).sort().join(',')).toBe('badge_count,badge_days,badge_focus_hours,badge_hours,badge_streak_months,badge_tasks,level_step,level_sub,level_tier,practice_minutes,retention,retention_cards,synthesis_gap_days,xp_today,xp_total');
