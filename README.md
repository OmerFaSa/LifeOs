...
|---|---|---|---|
| [`HKM/`](HKM/) | <img src="HKM/brand/favicon.png" width="20" valign="middle"/> **Hayat Kontrol Merkezi** | merkez katman: brifing, çapraz bulgu, etki, sohbet, niyet kuyruğu, ritim (test sayısı aşağıdaki sayılar bloğunda) | [`HKM/MIMARI.md`](HKM/MIMARI.md) |
