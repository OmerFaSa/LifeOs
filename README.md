...
_Bu bölüm elle yazılmaz: `python3 tools/sayilar.py --yaz` araçları koşturur ve her aracın kendi son satırını buraya yazar. Son koşum: 2026-09-23._

| Araç | AYS | SPI | ESP |
|---|---|---|---|
| `runtests.js` | 1512/1512 gecti | 1198/1198 gecti | 1244/1244 gecti |
...
| `perfcheck.js` | Bütün ekranlar bütçede — en ağırı office 48.5 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 24.2 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 47.6 ms (bütçe 100). |
...
| Depo denetimi | Sonuç |
|---|---|
| `HKM tests` | 418/418 test gecti |
| `HKM perf` | Bütün sorgular bütçede. |
| `HKM yuz` | HKM yüzü temiz — 48 görünümde taşma yok, bütün hedefler 24px ve üstü, etiketler yerinde, kontrast AA. |
...
| `ortak.py` | Ortak kaynak: kopyalar kaynakla ayni (25 dosya, 74 kopya). |
