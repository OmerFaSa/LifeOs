...
SP.App = (function(){
  ...
  /* Beş gezinme grubu — PDF'teki beş modülle birebir örtüşür. */
  const NAV = [
    { label:'Günlük', items:[
      { id:'today',  icon:'today', label:'Bugün' },
      { id:'vitals', icon:'pulse', label:'Günlük ölçüm' },
    ]},
    { label:'Ölçüm', items:[
      { id:'labs', icon:'flask', label:'Tahliller' },
    ]},
    { label:'Beslenme', items:[
      { id:'meals',   icon:'meal', label:'Öğünler' },
      { id:'kitchen', icon:'leaf', label:'Mutfak' },
    ]},
    { label:'Hareket', items:[
      { id:'move', icon:'dumbbell', label:'Hareket' },
    ]},
    { label:'Ekonomi', items:[
      { id:'basket', icon:'wallet', label:'Sepet' },
    ]},
    { label:'Analiz', items:[
      { id:'analytics', icon:'chart', label:'Analiz' },
    ]},
    { label:'Ofis', items:[
      { id:'office',  icon:'users', label:'Ofis' },
      { id:'team',    icon:'zap',   label:'Danışma' },
      { id:'meeting', icon:'list',  label:'Toplantı' },
    ]},
    { label:'Sistem', items:[
      { id:'family', icon:'heart', label:'Hane' },
  ...
  /* Balonu dışarıya tıklayınca kapat */
  ...
  return { boot, render, go, applyTheme, NAV, installManifest };
})();
