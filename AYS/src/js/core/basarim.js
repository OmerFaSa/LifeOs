...
/* BAŞARIM MOTORU — rozet sayar, kazanımı yakalar, defteri tutar.
   ...
   üç arayüzün `src/js/core/` klasörüne kopyalanır. `R` ve `ays`
   ...
   okunur (`R.BasarimSayim`), özete EŞİTLENİR, rozetler eşiklerden
...
R.Basarim = (function(){
  ...
  function odakHtml(dakika){
    ...
    if(!o) return '';
    var kac = (R.h && R.h.esc) ? R.h.esc : function(x){ return x; };
