#!/usr/bin/env python3
"""SPI — kaynak dosyalardan tek dosyalik dagitim uretir.
...
Artifact olarak yayimlanabilir bir parca (fragment) uretir: dist/spi.html
...
def build(minify: bool = False) -> None:
    ...
    title = title_match.group(1).strip() if title_match else "SPİ"
