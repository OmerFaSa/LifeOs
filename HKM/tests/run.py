...
from tests import (harness, test_bam, test_baslat, test_butce, test_channels,  # noqa: E402
                   ...
                   test_kaynakli, test_kitap, test_mufredat, test_urun, test_web,
...
def main():
    for mod in (test_vps, test_sync, test_precedence, test_twin,
                ...
                test_motto, test_yoklama, test_kanal, test_bam, test_king, test_mufredat, test_kitap, test_web, test_kaynakli, test_urun,
