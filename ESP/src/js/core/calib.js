/* Kalibrasyon defteri — kullanıcının kendi yargısını ÖLÇER.
   ...
   çıkar: kişi bu türlerde kendi sayılarını ne kadar kestirebiliyor? Bu
   sinyalin değeri, sistem kapandığında da elde kalmasıdır.
...
ESP.Calib = (function(){
  ...
  /* ------------------------------------------------------- HATA AİLELERİ
     ...
     değerlerde anlamsızca büyür: 3 oturumu 6 tahmin etmek %100 «hata»
     sayılıyordu, 30 oturumu 33 tahmin etmek %10 — oysa ikisi de 3
     oturumluk sapmadır.
     ...
     Aileler birbiriyle ortalanmaz — dakikadaki yüzde ile oturumdaki sapma
  ...
  return {
    ...
    list, settled, openList:open_, due, error, bandOf, errKind, bias, score, kindOf,
    ASGARI, PENCERE,
  };
})();
