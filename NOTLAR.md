...
| Araç | AYS | SPI | ESP |
|---|---|---|---|
| `runtests.js` | 1632/1632 gecti | 1267/1267 gecti | 1309/1309 gecti |
...
| `perfcheck.js` | Bütün ekranlar bütçede — en ağırı office 45 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 28 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 51.4 ms (bütçe 100). |
...
| `ortak.py` | Ortak kaynak: kopyalar kaynakla ayni (38 dosya, 113 kopya). |
