  ...
  describe('Depo — yedek', function(){
    ...
    it('geri yükleme bu cihazın HKM ayarını değiştirmez', async function(){
      await hkmIle(async function(){
        ...
        const yedekle = () => ({ __meta:{ app:uygulamaKimligi(), schemaVersion:SP.SCHEMA_VERSION },
    ...
    it('geri alma kopyası yazılamazsa eski kopya kalmaz, sonuç bunu söyler', async function(){
      ...
      try{
        ...
        const r = await S.importAll({ __meta:{ app:uygulamaKimligi(), schemaVersion:SP.SCHEMA_VERSION },
