...
| Araç | AYS | SPI | ESP |
|---|---|---|---|
| `runtests.js` | 1504/1504 gecti | 1190/1190 gecti | 1217/1217 gecti |
...
| `perfcheck.js` | Bütün ekranlar bütçede — en ağırı office 50.3 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 26.3 ms (bütçe 120). | Bütün ekranlar bütçede — en ağırı office 46.9 ms (bütçe 100). |
